...
class MrtParser():
       ...
       +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
        ...
        while p < len(buf):
            ...
            self.parseBgpAttributes(buf[p:p+rib_entry['attribute_length']], rib_entry['bgp_attribute_list'],
                                   rib_entry['raw_bgp_attributes'], rib_entry['attribute_length'], address_family, safi, raw_nlri)
    ...
    def parseBgpAttributes(self, buf, bgp_attribute_list, raw_bgp_attributes, attr_length, address_family, safi, raw_nlri):
        ...
        while p < attr_length:
            ...
            if BGP_ATTRIBUTES[bgp_path_attribute['type']] == 'NEXT_HOP':
                ...
                raw_bgp_attributes.append(self.crateMpReachNlriAttributeRaw(address_family, safi, (raw_next_hop_length + raw_next_hop), raw_nlri))
            ...
            # Parse out MP_REACH attribute
                ...
                raw_bgp_attributes.append(self.crateMpReachNlriAttributeRaw(address_family, safi, raw_next_hop_attr, raw_nlri))
    ...
    def crateMpReachNlriAttributeRaw(self, afi, safi, raw_next_hop, raw_nlri):
        ...
        attr_header = self.getMpReachNlriAttributeHeader(len(attr_body))

        return attr_header + attr_body
...
if __name__ == '__main__':
    ...
    mp = MrtParser("rib.20160301.1000.bz2")
